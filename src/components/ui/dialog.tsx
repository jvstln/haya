  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Viewport
        className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden py-6 [@media(min-height:600px)]:pt-8 [@media(min-height:600px)]:pb-12"
...
function DialogFooter({
  ...
  return (
    ...
    >
      ...
      {showCloseButton && (
        <DialogPrimitive.Close
          render={<Button appearance="outline" color="secondary" />}
        >
          Close
        </DialogPrimitive.Close>
      )}
