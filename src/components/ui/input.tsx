...
export const inputSizeClassName = cn(
  "h-8.75 rounded-md text-xs data-[size=lg]:h-17.5",
);

export const inputColorClassName = cn(
  "border-border bg-[linear-gradient(var(--color-muted),var(--color-muted))_content-box,var(--colorful-gradient)_border-box] selection:bg-primary selection:text-primary-foreground file:bg-transparent file:text-foreground placeholder:text-muted-foreground focus-visible:border-ring disabled:opacity-50 data-placeholder:text-muted-foreground data-disabled:opacity-50",
);
