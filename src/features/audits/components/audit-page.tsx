    ...
    <>
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-6">
          {audits.isPending ? (
            <>
              <Skeleton className="h-34.5 w-full max-w-53 rounded-2xl" />
              <Skeleton className="h-34.5 w-full max-w-53 rounded-2xl" />
            </>
          ) : audits.isError ? (
            <div className="flex h-34.5 w-53 flex-col items-center justify-center gap-2 rounded-2xl border border-destructive">
              <p className="text-red-500 text-sm">Error fetching analyses</p>
              <Button
                size="sm"
                variant="glass"
...
const AuditCard = ({
  ...
  return (
    <Comp
      ...
      type="button"
      className={cn(
        "hover:-mt-1 flex h-34.5 w-53 flex-col items-center justify-center gap-4 rounded-2xl bg-primary/15 p-4 text-primary shadow-primary transition hover:shadow-md",
        className
      )}
    >
